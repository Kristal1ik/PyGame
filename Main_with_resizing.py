import pygame
from pygame import display, Surface, RESIZABLE, transform, VIDEORESIZE
...
if __name__ == '__main__':
    ...
    while running:
        virtual_surface.blit(back_ground, (0, 0))
        world.draw()
        table.draw()
        scaled_surf = transform.scale(virtual_surface, size_now)
